...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | LGUI | TAB  |      |      | LAlt | Bksp |Space |   |Enter | RAlt |   -  |   =  | LEFT | DOWN | RIGHT|
   * `------------------------------------------------'   `------------------------------------------------'
   */
    [BASE] = LAYOUT(
        KC_ESC, KC_GRV, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC,
        MO(META), KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_BSLS,
        MO(SYMB), KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_UP, KC_RSFT,
        KC_LGUI, KC_TAB, XXXXXXX, XXXXXXX, KC_LALT, KC_BSPC, KC_SPC, KC_ENT, KC_RALT, KC_MINS, KC_EQL, KC_LEFT, KC_DOWN, KC_RGHT),
